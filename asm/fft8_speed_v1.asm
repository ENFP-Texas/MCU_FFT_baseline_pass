...
LDR R8, [R7 + #0]                    ; pc=036, raw=0x78000000
LDR R9, [R7 + #1]                    ; pc=037, raw=0x79000001
LDR R10, [R7 + #8]                   ; pc=038, raw=0x7a000008
LDR R11, [R7 + #9]                   ; pc=039, raw=0x7b000009
...
LDR R8, [R7 + #2]                    ; pc=048, raw=0x78000002
LDR R9, [R7 + #3]                    ; pc=049, raw=0x79000003
LDR R10, [R7 + #0x000a]              ; pc=050, raw=0x7a00000a
LDR R11, [R7 + #0x000b]              ; pc=051, raw=0x7b00000b
...
LDR R8, [R7 + #4]                    ; pc=064, raw=0x78000004
LDR R9, [R7 + #5]                    ; pc=065, raw=0x79000005
LDR R10, [R7 + #0x000c]              ; pc=066, raw=0x7a00000c
LDR R11, [R7 + #0x000d]              ; pc=067, raw=0x7b00000d
...
LDR R8, [R7 + #6]                    ; pc=078, raw=0x78000006
LDR R9, [R7 + #7]                    ; pc=079, raw=0x79000007
LDR R10, [R7 + #0x000e]              ; pc=080, raw=0x7a00000e
LDR R11, [R7 + #0x000f]              ; pc=081, raw=0x7b00000f
